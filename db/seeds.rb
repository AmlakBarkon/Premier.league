...
teams = Team.create([{team_name: "Chelsea", coach: "Antonio Conte",log:"https://lh3.googleusercontent.com/-_-grPaix4ZQ/AAAAAAAAAAI/AAAAAAAAr30/P4xhpy_3OwY/s0-c-k-no-ns/photo.jpg"},
  ...
  players = Player.create([{name: "Eduardo",nationality:"Portugal",age:34,img_url:"http://s.weltsport.net/bilder/spieler/gross/26152.jpg",team_id:1},
    ...
    {name:"Trent Alexander-Arnold", nationality:"England",age:"19",img_url:"http://s.weltsport.net/bilder/spieler/gross/288031.jpg",team_id:6},
  {name:"Nathaniel Clyne",nationality:"England",age:26,img_url:"http://s.weltsport.net/bilder/spieler/gross/132676.jpg",team_id:7},
{name:"Joe Gomez",nationality:"England",age:20, img_url:"http://s.weltsport.net/bilder/spieler/gross/268348.jpg",team_id:3},
{name:"Ragnar Klavan", nationality:"Estonia",age:32,img_url:"http://s.weltsport.net/bilder/spieler/gross/14457.jpg",team_id:8},
{name:"Dejan Lovren",nationality:"Croatia",age:28,img_url:"http://s.weltsport.net/bilder/spieler/gross/38683.jpg",team_id:3},
{name:"Joel Matip",nationality:"Cameroon",age:26,img_url:"http://s.weltsport.net/bilder/spieler/gross/156057.jpg",team_id:9},

{name:"Claudio Vravo",age:34,nationality:"Chile",img_url:"http://s.weltsport.net/bilder/spieler/gross/22943.jpg",team_id:4},
{name:"Willy Caballero",age:36,nationality:"Argentina",img_url:"http://s.weltsport.net/bilder/spieler/gross/17550.jpg",team_id:10},
{name:"Angus Gunn",age:21,nationality:"England",img_url:"http://s.weltsport.net/bilder/spieler/gross/227845.jpg",team_id:4},
{name:"Tosin Adarabioyo",age:20,nationality:"England",img_url:"http://s.weltsport.net/bilder/spieler/gross/252240.jpg",team_id:11},
